...
//
//     final drivingRespones = drivingResponesFromJson(jsonString);

import 'dart:convert';

DrivingRespones drivingResponesFromJson(String str) =>
    DrivingRespones.fromJson(json.decode(str));

String drivingResponesToJson(DrivingRespones data) =>
    json.encode(data.toJson());

class DrivingRespones {
  DrivingRespones({
    this.routes,
    this.waypoints,
    this.code,
  ...
  factory DrivingRespones.fromJson(Map<String, dynamic> json) =>
      DrivingRespones(
